...
ren = Rename-Item
#powershell
scp $env:USERPROFILE\.ssh\id_ed25519.pub kali@kali.tail66fc55.ts.net:/tmp/
#bash
...
potem przesyłam sobie ten plik na linuxa przeważnie dzięki scp $env:USERPROFILE\.ssh\id_ed25519.pub kali@kali.tail66fc55.ts.net:/tmp/
